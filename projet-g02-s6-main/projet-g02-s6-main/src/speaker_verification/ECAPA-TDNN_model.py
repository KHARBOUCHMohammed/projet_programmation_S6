...
class SpeakerVerification:
    ...
    def __init__(self, threshold: float):
        ...
        self.source_audio_files = [f for f in listdir( os.getcwd()+"/src/speaker_verification/data/source/") if
                                   isfile(join( os.getcwd()+"/src/speaker_verification/data/source/", f))]
